...
public class Vinery implements ModSupport {
    ...
    public void registerBlocks() {
        ...
        AEGIS_WINE_BLOCK = BLOCKS.register("aegis_wine", () -> new BotariumLiquidBlock(AEGIS_WINE_PROPS, BlockBehaviour.Properties.copy(Blocks.WATER).mapColor(MapColor.COLOR_LIGHT_BLUE)));
        CLARK_WINE_BLOCK = BLOCKS.register("clark_wine", () -> new BotariumLiquidBlock(CLARK_WINE_PROPS, BlockBehaviour.Properties.copy(Blocks.WATER).mapColor(MapColor.COLOR_LIGHT_BLUE)));
        MELLOHI_WINE_BLOCK = BLOCKS.register("mellohi_wine", () -> new BotariumLiquidBlock(MELLOHI_WINE_PROPS, BlockBehaviour.Properties.copy(Blocks.WATER).mapColor(MapColor.COLOR_LIGHT_BLUE)));
        STRAD_WINE_BLOCK = BLOCKS.register("strad_wine", () -> new BotariumLiquidBlock(STRAD_WINE_PROPS, BlockBehaviour.Properties.copy(Blocks.WATER).mapColor(MapColor.COLOR_LIGHT_BLUE)));
        APPLE_CIDER_BLOCK = BLOCKS.register("apple_cider", () -> new BotariumLiquidBlock(APPLE_CIDER_PROPS, BlockBehaviour.Properties.copy(Blocks.WATER).mapColor(MapColor.COLOR_YELLOW)));
        APPLE_WINE_BLOCK = BLOCKS.register("apple_wine", () -> new BotariumLiquidBlock(APPLE_WINE_PROPS, BlockBehaviour.Properties.copy(Blocks.WATER).mapColor(MapColor.COLOR_YELLOW)));
